...
const handleAnswerChange = (index: number, text: string, isCorrect: boolean) => {
    ...
    return (
        ...
        {answers.length < 6 && 
        <button type="button" 
        className="border my-2 border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
        onClick={handleAddAnswer}>Add Answer</button>
        }
